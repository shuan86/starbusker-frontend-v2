    ...
    var Login = function () {
        var onClickLogout = function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        dispath(member_2.initialMemberAction());
        ...
        return (react_1["default"].createElement(react_1["default"].Fragment, null,
            ...
            isMenuOpenState && (react_1["default"].createElement("div", { className: "nav-user-btn-list", ref: ref },
                ...
                memberData.isBusker ? react_1["default"].createElement("div", { className: "nav-user-btn-item nav-user-btn-item-busker", onClick: onClickBusker }, "\u8868\u6F14\u8005") : null))));
    };
